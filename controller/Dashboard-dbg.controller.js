 ...
 */
function(Controller, BaseController, ODataModel, MockServer, Filter, FilterOperator,Formatter) {
    "use strict";
    ...
    return BaseController.extend("alfa.com.co.zui5_gestioncotizaciones.controller.Dashboard", {
        onInit: function() {
            ...
            // Inicio modificación - Melisa Colorado(NetW) - 29/11/2024
            let UIStateData = this.getModel("UIState"); //.getProperty("/");
            // Fin modificación - Melisa Colorado(NetW) - 29/11/2024
        ...
        onAddActivity: function(oEvt) {
            ...
            let UIStateModel = this.getView().getModel("UIState");
            let UIStateData = UIStateModel.getData;
        ...
        onTipoActividadChange: function(oEvent) {
